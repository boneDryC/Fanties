    ...
    <s.Screen>
      ...
      >
        <a href={CONFIG.MARKETPLACE_LINK}>
          <StyledLogo alt={"logo"} src={"/config/images/logo.png"} style={{ paddingTop: 60}}/>
        </a>
        <s.SpacerSmall />
        <ResponsiveWrapper flex={1} style={{ padding: 10 }} test>
          ...
          >
            ...
            >
              <StyledButton
                onClick={(e) => {
                  window.open("https://paintswap.finance/marketplace/collections/0xBD905A2c22b83F4299b6c4779cA4344Fff25F136", "_blank");
                }}
                style={{
                  margin: "5px",
                }}
